...
function currentSalary(employees) {
    ...
    for (let employee of employees) {
        let totalSalary = employee.starting + employee.experience * employee.increment;
        total += totalSalary;
    }
    return total;
}
...
const salaryTotal = currentSalary(employees);
console.log(`Total salary provided by the company in a month: ${salaryTotal} tk`);
